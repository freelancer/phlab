...
final class DifferentialTestMakeDraftHeraldAction
  extends HeraldAction {

  const ACTIONCONST = 'differential.revision.test-make-draft';
  const DO_MAKE_DRAFT = 'revision.test-make-draft';

  public function getHeraldActionName() {
    return pht('test Make revision draft');
  }

  public function renderActionDescription($value) {
    return pht(
      'test Put revision in draft state.');
  }
